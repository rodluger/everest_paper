...
axes[0].axhline(0.2, color = 'k', ls = '-', alpha = 0.25, lw = 2)
axes[0].axhline(-0.2, color = 'k', ls = '-', alpha = 0.25, lw = 2)
transFigure = fig.transFigure.inverted()
coord1 = transFigure.transform(axes[0].transData.transform([18,0.2]))
coord2 = transFigure.transform(axes[1].transData.transform([11,0.2]))
line1 = Line2D((coord1[0],coord2[0]),(coord1[1],coord2[1]),
                                transform=fig.transFigure, color = 'k', ls = '-', alpha = 0.25, lw = 2)
coord1 = transFigure.transform(axes[0].transData.transform([18,-0.2]))
coord2 = transFigure.transform(axes[1].transData.transform([11,-0.2]))
