...
axk2sff.plot(k2sff_time, k2sff_flux, 'k.', alpha = 0.3, ms = 2)
axk2sff.set_ylim(0.9825e6, 1.0225e6)
axk2sff.set_xlim(1977.36, 2057.33)
...
axevr2.plot(evr2.time, y, 'k.', alpha = 0.3, ms = 2)
axevr2.set_ylim(1.00e6, 1.04e6)
axevr2.set_xlim(1977.36, 2057.33)
...
axk2sfff.set_ylim(0.98, 1.005)
axk2sfff.margins(0, None)
...
axevr2f.set_ylim(0.98, 1.005)
axevr2f.margins(0, None)
