...
chosen as the targets with the highest probability of being RR Lyrae AB stars
according to the \texttt{K2VARCAT} catalog \citep{Armstrong16}.
\footnote{\url{https://archive.stsci.edu/prepds/k2varcat/}}
...
44/100 \texttt{EVEREST 2.0} RR Lyrae stars showed signs of overfitting. For 8
...
stars, the improvement over version \texttt{1.0} is substantial. {\color{red} How
does \texttt{K2SFF} do?}
