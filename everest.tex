...
For a typical light curve segment of a \emph{K2} star with 30 aperture pixels, $N_{dat} \sim\ $2,000 and
...
$N_{reg} \gtrsim 2N_{dat}$, casting the model in this form can considerably speed up the
...
%
%Our grid along each $\lambda_n$ axis
