...
\shortauthors{Luger et al. 2017}

\begin{document}

\title{An update to the EVEREST K2 pipeline:\\ Short cadence, saturated stars, and Kepler-like\\ photometry down to $\Kp = 15$}
\author{Rodrigo Luger\altaffilmark{1,2}, Ethan Kruse\altaffilmark{1}, Daniel Foreman-Mackey\altaffilmark{3},\\
...
\altaffiltext{3}{Center for Computational Astronomy, Flatiron Institute, New York, NY 10010, USA}
...
\keywords{catalogs --- planets and satellites: detection --- techniques: photometric\\[0.2in]}
...
\emph{TESS}. For more information, refer to the documentation \edited{at
\url{https://rodluger.github.io/everest}.}
