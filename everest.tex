...
detector \citep[e.g.,][]{Petigura12}, we attempted to apply \texttt{SysRem} individually
...
We separately apply \texttt{SysRem} to each light curve chunk, obtaining one
...
\subsection{Misc}
{\color{red} EPIC 220651426: different de-trending power in each chunk. CBV tails.}
